...
def main(**args):
    ...
    for k,j in enumerate(args["timeSections"],start=1):
        if k == 1:
            ...
            args["fitBox"] = [None, 821.00, 491.00, 837.00, 515.00]
            args["timeList"] = 'timeranges.list.CAL51BIG'
            args["SCbchan"] = 30
            args["SCechan"] = 240
            ...
            args["fitBox"] = [None, 821.00, 491.00, 837.00, 515.00]
            args["timeList"] = 'timeranges.list.CAL52BIG'
            args["SCbchan"] = 30
            args["SCechan"] = 240
        ...
        if k == 3:
            ...
            args["fitBox"] = [None, 821.00, 491.00, 837.00, 515.00]
            args["timeList"] = 'timeranges.list.CAL53BIG'
            args["SCbchan"] = 30
            args["SCechan"] = 240
            args["excludeTelly"] = False
            args["time"] = AIPSList(j) 
